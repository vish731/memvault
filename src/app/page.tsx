...
function VaultScene() {"use client";
...
export default function Home() {
  const { account, signAndSubmitTransaction, network, changeNetwork } = useWallet();
          ...
          <form onSubmit={handleCreate} className="card flex flex-col gap-5 p-7 sm:p-8">
            <label className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                ...
                <label className="text-sm font-medium text-[var(--primary)] hover:text-[var(--primary-dark)] transition-colors cursor-pointer flex items-center gap-1.5">
